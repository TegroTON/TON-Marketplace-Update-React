            ...
            <section className="item-details section pt-5">
               <Container fluid>
                        ...
                        */}
                              ...
                              <Card className="border mb-4">
                                 <Card.Body className="p-0 p-lg-3">
                                    <Card.Title className="fs-20 mb-4">Auction ends in</Card.Title>
                                    <div className="d-flex flex-wrap">
                                       <Button variant="primary flex-fill m-2" data-bs-toggle="modal" data-bs-target="#BuyNowModal">Buy Now</Button>
                              ...
                              <Row>
                                 <Col xl="6" className="mx-auto mb-4">
                                    <Card className="border p-0">
                                       <a href="/user1" className="text-white hover p-3">
                                          <Card.Title className="color-grey fs-16 mb-4">Owner</Card.Title>
                                          <div className="d-flex align-items-center">
                                 ...
                                 <Col xl="6" className="mx-auto mb-4">
                                    <Card className="border p-0">
                                       <a href="/collection" className="text-white hover p-3">
                                          <Card.Title className="color-grey fs-16 mb-4">Collection</Card.Title>
                                          <div className="d-flex align-items-center">
                              ...
                              <Card className="border mb-4">
                                 <Card.Body className="p-0 p-lg-3">
                                    <Card.Title className="fs-20 mb-4">Details</Card.Title>
